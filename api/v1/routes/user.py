...
async def get_user_by_id(
    ...
    """Endpoint to get a user by ID or unique_id in case ID fails.
...
async def deactivate_account(
    ...
    user = User.update(db, entity.id, is_active=False)
